...
export default class DshPlugin extends Plugin {
  ...
  async onload(): Promise<void> {
    ...
    // Ribbon icon with the official dsh logo (SVG replaces the Lucide placeholder).
    const ribbonItem = this.addRibbonIcon("bot", "Open DSH", () => {
      this.openDshView();
    });
